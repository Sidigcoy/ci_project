      ...
      <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
				  <a href='<?php echo base_url(); ?>user/erick/attendance_to_excel' class='btn btn-primary'><span style='color:white;'>Attendance</span></a> <br>
          <br>
          <a href='<?php echo base_url(); ?>user/erick/spkl_to_excel' class='btn btn-primary'><span style='color:white;'>SPKL</span></a> 
