...
<table id="example1" class="table table-bordered table-hover dataTable" border='2px'>
	<thead style="background-color:#000099;font-weight:bold">
	  <tr>
		...
		<th style="width: 500px; background-color: #3c8dbc; color: seashell;">P_LAST_ED</th>
		<th style="width: 500px; background-color: #3c8dbc; color: seashell;">P_M_STATUS</th>
	</thead>
	<tbody>
		<?php  
		$no = 1;
		...
		<tr height="12.5px">
			...
			<td><?php echo ucwords($lihat->P_EDUCATION);?></td>
			<td><?php echo ucwords($lihat->P_STATUS);?></td>
